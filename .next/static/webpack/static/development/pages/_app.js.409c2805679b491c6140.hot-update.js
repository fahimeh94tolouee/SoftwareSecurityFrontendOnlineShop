...
var getList = function getList() {
  return Object(_utilities_request__WEBPACK_IMPORTED_MODULE_0__["default"])({
    method: "get",
    url: "".concat(baseUrl).concat(_constants_api__WEBPACK_IMPORTED_MODULE_1__["PRODUCT_API"]).concat(_constants_api__WEBPACK_IMPORTED_MODULE_1__["QUESTION_LIST_API"]),
    needToken: true
  });
};
var store = function store(data) {
  return Object(_utilities_request__WEBPACK_IMPORTED_MODULE_0__["default"])({
    method: "post",
    url: "".concat(baseUrl).concat(_constants_api__WEBPACK_IMPORTED_MODULE_1__["PRODUCT_API"]).concat(_constants_api__WEBPACK_IMPORTED_MODULE_1__["QUESTION_API"]),
    needToken: true,
    data: data
  });
};
var update = function update(id, data) {
  return Object(_utilities_request__WEBPACK_IMPORTED_MODULE_0__["default"])({
    method: "put",
    url: "".concat(baseUrl).concat(_constants_api__WEBPACK_IMPORTED_MODULE_1__["PRODUCT_API"]).concat(_constants_api__WEBPACK_IMPORTED_MODULE_1__["QUESTION_API"]).concat(id),
    needToken: true,
    data: data
  });
};
  ...
  return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function rootSaga$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_1__["all"])([Object(_auth__WEBPACK_IMPORTED_MODULE_2__["watcherAuth"])(), Object(_user__WEBPACK_IMPORTED_MODULE_3__["watcherUser"])(), Object(_product__WEBPACK_IMPORTED_MODULE_4__["watcherProduct"])(), Object(_question__WEBPACK_IMPORTED_MODULE_5__["watcherQuestion"])()]);
...
function getList() {
  return _api_question__WEBPACK_IMPORTED_MODULE_4__["getList"]();
}
...
function storeReq(data) {
  return _api_question__WEBPACK_IMPORTED_MODULE_4__["store"](data);
}
    ...
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_1__["call"])(storeReq, action.data);
...
function updateReq(id, data) {
  return _api_question__WEBPACK_IMPORTED_MODULE_4__["update"](id, data);
}
    ...
    while (1) {
      switch (_context4.prev = _context4.next) {
        case 0:
          _context4.prev = 0;
          _context4.next = 3;
          return Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_1__["call"])(updateReq, action.id, action.data);
...
//# sourceMappingURL=_app.js.409c2805679b491c6140.hot-update.js.map